...
-   Être capable de choisir les meilleurs outils en fonction de la taille des jeux de données à traiter, en particulier pour les (très) gros jeux de données (= big data)
...
`r learnr("B08Lb_bigd", title = "Données volumineuses (big data)", toc = "onnées volumineuses (big data)")`
